...
#define PMTRACE_BEFORE(label) \
    tracepoint(pmtrace_audiod, before, label)
#define PMTRACE_AFTER(label) \
    tracepoint(pmtrace_audiod, after, label)
...
#define PMTRACE_SCOPE_ENTRY(label) \
    tracepoint(pmtrace_audiod, scope_entry, label)
#define PMTRACE_SCOPE_EXIT(label) \
    tracepoint(pmtrace_audiod, scope_exit, label)
...
#define PMTRACE_FUNCTION_ENTRY(label) \
    tracepoint(pmtrace_audiod, function_entry, label)
#define PMTRACE_FUNCTION_EXIT(label) \
    tracepoint(pmtrace_audiod, function_exit, label)
